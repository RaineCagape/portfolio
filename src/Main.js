...
const NavMob = () => (
  <div className='nav-list-mob'> 
                 ...
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/portfolio/info'>About</a></p>
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/portfolio/skills'>Skills</a></p>
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/portfolio/works'>Works</a></p>
