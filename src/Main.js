...
const NavMob = () => (
  ...
  <div className='nav-list-mob'> 
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio' target="_blank">Intro</a></p>
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/info' target="_blank">About</a></p>
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/skills' target="_blank">Skills</a></p>
                 <p className="list" ><FontAwesomeIcon className="arrow" icon={faCaretRight} /><a href='https://rainecagape.github.io/portfolio/#/works' target="_blank">Works</a></p>
